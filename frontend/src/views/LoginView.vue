    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
      ...
      <div class="mb-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
        <div class="flex items-center">
          ...
          <div>
            <h3 class="text-sm font-medium text-blue-800 dark:text-blue-200">Demo Mode</h3>
            <p class="text-sm text-blue-700 dark:text-blue-300 mt-1">
              Form is pre-filled for easy testing. Just click "Sign in"!
            </p>
          </div>
        </div>
      </div>
          ...
          <div>
            ...
            <div class="mt-1">
              <input
                ...
                required
                v-model="form.email"
                class="appearance-none block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md placeholder-gray-400 dark:placeholder-gray-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-colors"
...
const handleLogin = async () => {
  ...
  try {
    console.log('Demo login attempt:', form)
    ...
    // Redirect to vocabulary page for demo
