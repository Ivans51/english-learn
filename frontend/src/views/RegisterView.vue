<template>
  ...
  >
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
      <div
        class="bg-white dark:bg-primary-900 py-8 px-4 shadow sm:rounded-lg sm:px-10 transition-colors"
      >
        <form class="space-y-6" @submit.prevent="handleRegister">
          ...
          <div class="flex items-center">
            ...
            >
              I agree to the
              <a href="#" class="text-accent-600 hover:text-accent-500">
                Terms of Service
              </a>
              and
              <a href="#" class="text-accent-600 hover:text-accent-500">
        ...
        <div class="mt-6">
          <div class="relative">
            <div class="absolute inset-0 flex items-center">
              <div
                class="w-full border-t border-primary-300 dark:border-primary-600"
              />
            </div>
